          ...
          <div className={styles.info}>
            ...
            <div className={styles.workingHours}>
              ...
              <div className={styles.socialMedia}>
                <a href="https://www.facebook.com/gsdinc" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
                </a>
                <a href="https://www.instagram.com/getservicedoneinc" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
